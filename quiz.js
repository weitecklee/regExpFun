const message1 = [` _______ _           _   _             _ _      __      _ _        _`,
`|__   __| |         | | ( )           | | |    / _|    | | |      | |`,
...
const message2 = [` _______ _                 _                           __                                      _   _                _`,
`|__   __| |               | |                         / _|                                    | | (_)              | |`,
...
const secretCode = message1.concat(message2.map((a) => ' '.repeat(55).concat(a)));
...
for (let i = 0; i < secretCode.length; i++) {
  secretCode[i] = secretCode[i].replace(/ \| /g,'@')
    ...
    .replace(/ \|/g,'+')
    .replace(/[\\/]/g, (m)=>(m === '\\' ? '/' : '\\'))
    .replace(/\s+/g,(m)=>(m.length))
    .replace(/_+/g, (m)=>('_ABCDEFGHIJKLMNOPQRSTUVWXYZ'[m.length]));
};
